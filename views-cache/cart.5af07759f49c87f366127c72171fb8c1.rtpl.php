                        ...
                        <form action="/checkout">
                                    ...
                                    <tr class="cart_item">
                                        ...
                                        <td class="product-quantity">
                                            <div class="quantity buttons_added">
                                                ...
                                                <input type="number" size="4" class="input-text qty text" title="Qty" value="<?php echo htmlspecialchars( $value1["nrqtd"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" min="0" step="1" style="background-color: #313131">
                            ...
                            <div class="cart-collaterals">
                                ...
                                <div class="cross-sells">
                                    <small>Atenção! Recomendamos que solicite um orçamento antes de finalizar a compra, principalmente caso queira adquirir álbuns ou painéis. No caso da impressão fotográfica, não é necessário informar a quantidade neste momento; em seguida você irá enviar suas fotos e quantidade será acrescida.</small>
