                        ...
                        <div class="col-sm-6">
                            <div class="product-inner">
                                ...
                                <form action="/cart/<?php echo htmlspecialchars( $product["idproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/add" class="cart">
                                    <div class="quantity">
                                        <input type="number" size="4" style="background-color: grey;" class="input-text qty text" title="Qty" value="1" name="qtd" min="1" step="1">
                                    </div>
                                ...
                                <div class="product-inner-category">
                                    ...
                                    <div role="tabpanel">
                                        <ul class="product-tab" role="tablist">
                                            <li role="presentation" class="active"><a href="#" aria-controls="home" role="tab" data-toggle="tab">Descrição</a></li>                          
                                        </ul>
                                        <div class="tab-content">
                                            <div role="tabpanel" class="tab-pane fade in active" id="home">           
                                                <p><?php echo htmlspecialchars( $product["vllength"], ENT_COMPAT, 'UTF-8', FALSE ); ?></p>                                           
                                            </div>                                        
                                        </div>
                                    </div>
                                </div>
