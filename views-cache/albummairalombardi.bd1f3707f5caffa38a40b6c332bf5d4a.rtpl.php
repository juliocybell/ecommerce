    ...
    <div class="row">
      <div class="col-md-12">
        <div class="product-bit-title text-center">
          <h2>Álbum Linha Maira Lombardi</h2>
        </div>
      </div>
    </div>
  </div>
...
<div id="jssor_1" style="position: relative; margin: 0 auto; top: 0px; left: 0px; width: 600px; height: 600px; overflow: hidden; visibility: hidden;">
  ...
  <div data-u="slides" style="cursor: default; position: relative; top: 0px; left: 0px; width: 600px; height: 600px; overflow: hidden;">
    <div data-p="112.50" style="display: none;">
      <img data-u="image" src="/res/site/img/products/314.jpg" />        
    </div>
    <div data-p="112.50" style="display: none;">
      <img data-u="image" src="/res/site/img/products/AlbumLinha MairaLombardi1.jpg" />           
    </div>
    <div data-p="112.50" style="display: none;">
      <img data-u="image" src="/res/site/img/products/AlbumLinha MairaLombardi3.jpg" />            
    </div>
    <div data-p="112.50" style="display: none;">
      <img data-u="image" src="/res/site/img/products/AlbumLinha MairaLombardi4.jpg" />           
    </div>
  </div>
