        ...
        <div class="row">                
            ...
            <div class="col-md-9">
                ...
                <form action="/profile/change-password" method="post">
                    ...
                    <input type="password" class="form-control" id="current_pass" name="current_pass" style="background-color: grey">
                    </div>
                    <hr>
                    <div class="form-group">
                    <label for="new_pass">Nova Senha</label>
                    <input type="password" class="form-control" id="new_pass" name="new_pass" style="background-color: grey">
                    </div>
                    <div class="form-group">
                    <label for="new_pass_confirm">Confirme a Nova Senha</label>
                    <input type="password" class="form-control" id="new_pass_confirm" name="new_pass_confirm" style="background-color: grey">
                    </div>
