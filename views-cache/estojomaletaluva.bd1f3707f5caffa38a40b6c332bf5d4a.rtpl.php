...
<div id="jssor_1" style="position: relative; margin: 0 auto; top: 0px; left: 0px; width: 600px; height: 600px; overflow: hidden; visibility: hidden;">
  ...
  <div data-u="slides" style="cursor: default; position: relative; top: 0px; left: 0px; width: 600px; height: 600px; overflow: hidden;">
    <div data-p="112.50" style="display: none;">
      <img data-u="image" src="/res/site/img/products/317.jpg" />        
    </div>
    <div data-p="112.50" style="display: none;">
      <img data-u="image" src="/res/site/img/products/318.jpg" />           
    </div>
    <div data-p="112.50" style="display: none;">
      <img data-u="image" src="/res/site/img/products/EstojoAlbum7.jpg" />            
    </div>
    <div data-p="112.50" style="display: none;">
      <img data-u="image" src="/res/site/img/products/EstojoAlbum1.jpg" />           
    </div>
    <div data-p="112.50" style="display: none;">
      <img data-u="image" src="/res/site/img/products/EstojoAlbum2.jpg" />            
    </div>
    <div data-p="112.50" style="display: none;">
      <img data-u="image" src="/res/site/img/products/EstojoAlbum3.jpg" />            
    </div>
    <div data-p="112.50" style="display: none;">
      <img data-u="image" src="/res/site/img/products/EstojoAlbum4.jpg" />            
    </div>    
    <div data-p="112.50" style="display: none;">
      <img data-u="image" src="/res/site/img/products/EstojoAlbum6.jpg" />            
    </div>   
  </div>
