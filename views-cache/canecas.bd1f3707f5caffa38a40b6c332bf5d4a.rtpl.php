 ...
 <div id="jssor_1" style="position: relative; margin: 0 auto; top: 0px; left: 0px; width: 600px; height: 600px; overflow: hidden; visibility: hidden;">
    ...
    <div data-u="slides" style="cursor: default; position: relative; top: 0px; left: 0px; width: 600px; height: 600px; overflow: hidden;">
      <div data-p="112.50" style="display: none;">
        <img data-u="image" src="/res/site/img/products/270.jpg" />        
      </div>
      <div data-p="112.50" style="display: none;">
        <img data-u="image" src="/res/site/img/products/273.jpg" />           
      </div>
      <div data-p="112.50" style="display: none;">
        <img data-u="image" src="/res/site/img/products/274.jpg" />            
      </div>
      <div data-p="112.50" style="display: none;">
        <img data-u="image" src="/res/site/img/products/CanecaCromada1.jpg" />           
      </div>
      <div data-p="112.50" style="display: none;">
        <img data-u="image" src="/res/site/img/products/CanecaCromada3.jpg" />            
      </div>
      <div data-p="112.50" style="display: none;">
        <img data-u="image" src="/res/site/img/products/CanecaCromada4.jpg" />            
      </div>
      <div data-p="112.50" style="display: none;">
        <img data-u="image" src="/res/site/img/products/CanecaCromada5.jpg" />            
      </div>    
      <div data-p="112.50" style="display: none;">
        <img data-u="image" src="/res/site/img/products/CanecaCromada7.jpg" />            
      </div>
      <div data-p="112.50" style="display: none;">
        <img data-u="image" src="/res/site/img/products/CanecaCromada8.jpg" />            
      </div>
    </div>
